...
export default function Home() {
    ...
    return (
        <>
            ...
            <div id='countdown' className='mt-28 md:mt-48 mx-auto px-12 md:px-36'>
                <PixelTransition
                    ...
                    firstContent={
                        ...
                        >
                            <div>
                                <p className='font-hero text-center text-base md:text-4xl font-bold'><b className='text-sekunder-green'>c</b>o<b className='text-sekunder-blue'>m</b>m<b className='text-sekunder-red'>i</b>ng <b className='text-sekunder-yellow'>s</b>o<b className='text-sekunder-red'>o</b>n<b className='text-sekunder-blue'>!</b></p>
                                <Countdown initialSeconds={getTotalSecondsToDate(new Date('2025-07-12T19:00:00'))} />
                            </div>
                        </div>
                    }
                    secondContent={
            ...
            <div className='mt-24 md:mt-56 grid-background mx-auto w-full bg-[#1e1e1e] rounded-t-xl px-0 md:px-6 pb-4 pt-20'>
                <ScrambledText
                    ...
                    scrambleChars={'.:'}
                >
                    Meet The <b className='text-sekunder-blue'>P</b>
